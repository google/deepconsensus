...
from google3.third_party.nucleus.protos import cigar_pb2
from google3.third_party.nucleus.protos import reads_pb2
from google3.third_party.nucleus.util import cigar as cigar_utils
...
class CreateDeepConsensusInputDoFn(beam.DoFn):
